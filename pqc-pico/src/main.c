...
static uint8_t message[] =
    "SPHINCS+-SHA2-128s-simple Functional Validation";
...
int main(void)
{
    ...
    )
    {
        ...
        printf("SPHINCS+-SHA2-128s-simple functional validation successful.\n");
    ...
    else
    {
        ...
        printf("SPHINCS+-SHA2-128s-simple functional validation failed.\n");
